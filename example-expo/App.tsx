...
export default function App() {
  ...
  if (showWebView) {
    return (
      <View style={styles.container}>
        ...
        <Flourish genericEventCallback={printEventsCallback} />
      </View>
    );
  }
  ...
  return (
    <View style={styles.homeContainer}>
      ...
      <Text style={styles.title}>Flourish Expo Example</Text>
      <Text style={styles.subtitle}>Testing SDK with Expo 53</Text>
